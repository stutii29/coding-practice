...
| `[top_k_frequent_elements.py](https://leetcode.com/problems/top-k-frequent-elements/editorial/)` | Frequency counting + bucket sort | Medium |
| `[longest_consecutive_sequence.py](https://leetcode.com/problems/longest-consecutive-sequence/editorial/)` | Set membership, sequence detection | Medium |
